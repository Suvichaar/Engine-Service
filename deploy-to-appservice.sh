...
Example:
  ./deploy-to-appservice.sh news-rg news-plan newsengine-api newsacr latest centralindia
...
Environment variables:
  ...
  IMAGE_NAME        Docker image repository name. Default: newsengine-backend
...
IMAGE_NAME="${IMAGE_NAME:-newsengine-backend}"
